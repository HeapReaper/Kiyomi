        ...
        <div class="col-sm">
          <div class="pt-2 pb-2 pl-2 pr-2 mb-2 mt-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" name="name" aria-describedby="fullname" placeholder="Voornaam achternaam" value="{{ $user->name }}" required disabled>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="birthdate" name="birthdate" placeholder="01-01-2024" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $user->birthdate)->format('d-m-Y') }}" required disabled>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm">
          <div class="pt-2 pb-2 pl-2 pr-2 mb-2 mt-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="address" name="address" placeholder="Straatnaam nummer" value="{{ $user->address }}" required disabled>
            </div>

            <div class="form-group">
              <label for="postcode"  class="text-white font-weight-bold"><strong>Postcode</strong></label>
              <input type="text" class="form-control" id="postcode" name="postcode" placeholder="1234AH (zonder spatie!)" value="{{ $user->zip_code }}" required disabled>
            </div>

            <div class="form-group">
              <label for="city"  class="text-white font-weight-bold"><strong>Woonplaats</strong></label>
              <input type="text" class="form-control" id="city" name="city" placeholder="Woonplaats" value="{{ $user->city }}" required disabled>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm">
          <div class="pt-2 pb-2 pl-2 pr-2 mb-2 mt-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="phone" name="phone" placeholder="0612343455 (nummer zonder streepje!)" value="{{ $user->mobile_phone }}" required disabled>
            </div>

            <div class="form-group">
              <label for="email" class="text-white font-weight-bold"><strong>E-mail</strong></label>
              <input type="email" class="form-control" id="email" name="email" placeholder="mail@provider.nl" value="{{ $user->email }}" required disabled>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row bg-dark rounded bg-opacity-25 shadow-lg mt-2">
        <div class="col">
          <div class="pt-2 pb-2 pl-2 pr-2 mb-2 mt-2">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="RC motorplane" id="PlaneCertCheckbox" name="licences[]" disabled
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="RC helicopter" id="HeliCertCheckbox" name="licences[]" disabled
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="RC glider" id="gliderCertCheckbox" name="licences[]" disabled
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="RC multicopter" id="multicopterCertCheckbox" name="licences[]" disabled
        ...
        <div class="col">
          <div class="pt-2 pb-2 ps-2 pe-2 mb-2 mt-2 w-25">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="Drone A1" id="droneA1Checkbox" name="licences[]" disabled
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="Drone A2" id="droneA2Checkbox" name="licences[]" disabled
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="Drone A3" id="droneA3Checkbox" name="licences[]" disabled
