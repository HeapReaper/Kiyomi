      ...
      <div class="m-2">
        <div class="container mt-5 bg-dark bg-opacity-25 rounded shadow-lg p-2" style="max-width: 400px">
          ...
          <form action="{{ route('password.update') }}" method="POST" class="col-auto pt-4 pb-4 mw-50">
            ...
            <label for="password_confirmation" class="text-white"><strong>Wachtwoord bevestiging</strong></label>
            ...
            <button type="submit" class="btn text-white mt-2" style="background-image: linear-gradient(45deg, #874da2 0%, #c43a30 100%)">Reset</button>
          </form>
        </div>
      </div>
    </main>
