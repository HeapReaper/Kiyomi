    ...
    <main>
      <div class="m-2">
        <div class="container mt-5 bg-dark bg-opacity-25 rounded shadow-lg p-2" style="max-width: 400px">
          ...
          <h2 class="text-white text-center pt-3">TOTP</h2>

          <form class="col-auto pt-4 pb-4 mw-50" method="POST" action="/2fa/verify">
            @csrf
            <label for="code" class="text-white"><strong>TOTP code invullen</strong></label>
            <input type="text" class="form-control mt-2" id="code" name="code" aria-describedby="code" placeholder="">
      ...
      @if (session()->has('error'))
        <div class="toast-container showposition-fixed bottom-0 end-0 p-3">
          <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <img src="/app_media/trmc.png" class="rounded me-2" alt="..." style="max-width: 35px">
              <strong class="me-auto">Oeps!</strong>
              <small>Een paar seconden geleden</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
            <div class="toast-body">
